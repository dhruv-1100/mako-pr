...
public:
    enum {
        ...
        ACCEPT = 0x1e24c4e7,
        DECIDE = 0x16ff5504,
        HEARTBEAT = 0x13d1b956,
        FORWARDTOLEARNERSERVER = 0x39e6bd67,
        BULKPREPARE = 0x543ca62c,
        BULKACCEPT = 0x370aa48d,
        BULKPREPARE2 = 0x28d471dd,
        SYNCLOG = 0x44cbc3a8,
        SYNCCOMMIT = 0x1d31ef1e,
        SYNCNOOPS = 0x14399175,
        BULKDECIDE = 0x59e2c2bc,
    };
...
public:
    enum {
        MSGSTRING = 0x545a0bc5,
        MSGMARSHALL = 0x3acdbd16,
        DISPATCH = 0x44a6ac3e,
        PREPARE = 0x6c676ab2,
        COMMIT = 0x261f465a,
        ABORT = 0x31c32c3d,
        UPGRADEEPOCH = 0x47d1dab5,
        TRUNCATEEPOCH = 0x67ea7445,
        RPC_NULL = 0x1e9f8176,
        TAPIRACCEPT = 0x45d20384,
        TAPIRFASTACCEPT = 0x168b06d6,
        TAPIRDECIDE = 0x4189bf8d,
        RCCDISPATCH = 0x414f1ede,
        RCCFINISH = 0x4808beea,
        RCCINQUIRE = 0x5a1a2db4,
        RCCDISPATCHRO = 0x57a9e3b1,
        RCCINQUIREVALIDATION = 0x151ff680,
        RCCNOTIFYGLOBALVALIDATION = 0x580582cc,
        JANUSDISPATCH = 0x31b2c5b1,
        JANUSCOMMIT = 0x324ffa7b,
        JANUSCOMMITWOGRAPH = 0x2bb2d3f2,
        JANUSINQUIRE = 0x6cd0ca73,
        JANUSPREACCEPT = 0x1d6d322e,
        JANUSPREACCEPTWOGRAPH = 0x36615d0f,
        JANUSACCEPT = 0x5f59b498,
        PREACCEPTFEBRUUS = 0x55de63bf,
        ACCEPTFEBRUUS = 0x1a493fad,
        COMMITFEBRUUS = 0x639ab107,
    };
    int __reg_to__(rrr::Server* svr) {
        int ret = 0;
...
private:
    ...
    void __TapirAccept__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        uint64_t* in_0 = new uint64_t;
        req->m >> *in_0;
    ...
    void __TapirFastAccept__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        uint64_t* in_0 = new uint64_t;
        req->m >> *in_0;
    ...
    void __TapirDecide__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        uint64_t* in_0 = new uint64_t;
        req->m >> *in_0;
    ...
    void __RccDispatch__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
    ...
    void __RccFinish__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
    ...
    void __RccInquire__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
    ...
    void __RccDispatchRo__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
    ...
    void __RccInquireValidation__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
    ...
    void __RccNotifyGlobalValidation__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        txid_t* in_0 = new txid_t;
        req->m >> *in_0;
    ...
    void __JanusDispatch__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        std::vector<SimpleCommand>* in_0 = new std::vector<SimpleCommand>;
        req->m >> *in_0;
        rrr::i32* out_0 = new rrr::i32;
        TxnOutput* out_1 = new TxnOutput;
    ...
    void __JanusCommit__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        cmdid_t* in_0 = new cmdid_t;
        req->m >> *in_0;
    ...
    void __JanusCommitWoGraph__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        cmdid_t* in_0 = new cmdid_t;
        req->m >> *in_0;
        rank_t* in_1 = new rank_t;
        req->m >> *in_1;
    ...
    void __JanusInquire__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        epoch_t* in_0 = new epoch_t;
        req->m >> *in_0;
        txnid_t* in_1 = new txnid_t;
        req->m >> *in_1;
    ...
    void __JanusPreAccept__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        cmdid_t* in_0 = new cmdid_t;
        req->m >> *in_0;
        rank_t* in_1 = new rank_t;
        req->m >> *in_1;
    ...
    void __JanusPreAcceptWoGraph__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        cmdid_t* in_0 = new cmdid_t;
        req->m >> *in_0;
        rank_t* in_1 = new rank_t;
        req->m >> *in_1;
    ...
    void __JanusAccept__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        cmdid_t* in_0 = new cmdid_t;
        req->m >> *in_0;
        ballot_t* in_1 = new ballot_t;
        req->m >> *in_1;
    ...
    void __PreAcceptFebruus__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        txid_t* in_0 = new txid_t;
        req->m >> *in_0;
        rrr::i32* out_0 = new rrr::i32;
    ...
    void __AcceptFebruus__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        txid_t* in_0 = new txid_t;
        req->m >> *in_0;
        ballot_t* in_1 = new ballot_t;
        req->m >> *in_1;
    ...
    void __CommitFebruus__wrapper__(rusty::Box<rrr::Request> req, std::weak_ptr<rrr::ServerConnection> weak_sconn) {
        txid_t* in_0 = new txid_t;
        req->m >> *in_0;
        uint64_t* in_1 = new uint64_t;
        req->m >> *in_1;
...
public:
    enum {
        SERVER_SHUTDOWN = 0x44bc58da,
        SERVER_READY = 0x48f5ca1a,
        SERVER_HEART_BEAT_WITH_DATA = 0x43381b54,
        SERVER_HEART_BEAT = 0x5deafe74,
    };
    int __reg_to__(rrr::Server* svr) {
        int ret = 0;
...
public:
    enum {
        CLIENT_GET_TXN_NAMES = 0x43efe166,
        CLIENT_SHUTDOWN = 0x3b7711f5,
        CLIENT_FORCE_STOP = 0x57b8cb99,
        CLIENT_RESPONSE = 0x20768eb8,
        CLIENT_READY = 0x10800ab3,
        CLIENT_READY_BLOCK = 0x403b2798,
        CLIENT_START = 0x10baea9a,
        DISPATCHTXN = 0x3b59554a,
    };
    int __reg_to__(rrr::Server* svr) {
        int ret = 0;
